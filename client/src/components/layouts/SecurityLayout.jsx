...
import SecurityNav from "./navbars/SecurityNav";
import SecuritySidebar from "./sidebars/SecuritySidebar";
...
export default function SecurityLayout() {
  ...
  return (
    <div className="security-layout min-h-screen" style={{ backgroundColor: "var(--color-cream)" }}>
      <style>{`
        .security-layout .mobile-overlay {
          position: fixed; inset: 0; background: rgba(0,0,0,0.45);
          z-index: 40; opacity: 0; pointer-events: none;
          backdrop-filter: blur(2px);
        }
        @media (min-width: 768px) {
          .security-layout .main-content {
